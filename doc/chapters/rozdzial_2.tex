...
Prócz scenariuszy, użytecznym elementem specyfikacji był szkic interfejsu użytkownika (rysunek \ref{wireframe}). Podczas implementacji nanoszone były na niego nieznaczne zmiany.
...
\begin{description}
	\item[Antyterrorysta]
	\item[Antyterrorysta lider]
	\item[Interfejs]
	\item[Jednostka]
	\item[Konfiguracja]
	\item[Punkt kluczowy]
	\item[Punkt startowy / końcowy]
	\item[Statystyki]
	\item[Symulacja]
	\item[Terrorysta]
\end{description}
